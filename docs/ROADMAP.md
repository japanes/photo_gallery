...
- [x] No backdrop click to close, no escape key handler (template, line 14)
- [x] No focus trap for accessibility (template, line 15)
- [x] No drag-and-drop support (template, line 24)
- [x] No file type restriction in UI, only in validation (template, line 25)
- [x] Error message shown incorrectly (template, line 32)
- [x] Albums not loaded, empty select (template, line 55)
- [x] No upload progress bar (template, line 81)
- [x] Preview shown even when no file selected (template, line 93)
- [x] No file size validation (line 236)
- [x] No file type validation beyond accept attribute (line 237)
- [x] FileReader not cleaned up, potential memory leak (line 242)
- [x] Tags not properly parsed from comma-separated string (line 259)
- [x] No error handling, no progress tracking (line 266)
- [x] No user-visible error notification (line 277)
